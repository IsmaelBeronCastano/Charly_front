...
const Main = () => {
  return (
    <div className="flex flex-col md:flex-row">
        <img className="w-full md:w-1/2 pl-4" src={Imagen} alt="charly portada clics modernos" />
        <section className="w-full md:w-1/2 mb-10 pl-4">
            ...
            <p><span className="text-xl">https://charly-api.up.railway.app/api/v2/discos</span></p> 
