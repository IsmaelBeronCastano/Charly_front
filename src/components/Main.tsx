...
const Main = () => {
  return (
    <div className="flex flex-col md:flex-row">
        ...
        <section className="w-full md:w-1/2 mb-10">
            ...
            <NavigationResult />
            <div className="mt-6">
            <p className="text-xl font-bold mt-3 mb-2 pl-1">El uso es sencillo, añadir al endpoint: </p>
            <p><span className="text-xl pl-1">https://charly-api2.up.railway.app/api/v2/discos</span></p> 
             <p className="mt-4 pl-1"><span>Para el álbum: </span>/album/NombreDelAlbumEnPascalCase</p>
             <p className="pl-1"><span>Para la fecha: </span>/fecha/1996</p>
             <p className="pl-1"><span>Para la canción: </span>/cancion/TituloDeLaCancionEnPascalCase</p>
            </div>
        </section>
